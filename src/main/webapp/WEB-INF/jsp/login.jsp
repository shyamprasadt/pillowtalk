...
<div align="center">
<h2 align="justify">Login with Username and Password</h2>

		

		<form name='loginForm' action="<c:url value='j_spring_security_check' />" method='POST' modelAttribute="user">
...
<center><a href="reg">Register</a></center>
